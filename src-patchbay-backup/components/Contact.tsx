...
export default function Contact() {
  return (
    <footer id="contact" className="relative overflow-hidden py-20 md:py-28">
      <div className="pointer-events-none absolute inset-x-0 top-0 h-24 -scale-y-100 opacity-25 md:h-32">
        <Waveform className="h-full w-full" animated={false} />
      </div>

      <div className="relative mx-auto max-w-5xl px-6 md:px-10">
        <p className="font-mono text-xs uppercase tracking-[0.2em] text-[var(--color-signal)]">04 — Contact</p>
